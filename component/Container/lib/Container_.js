...
;var Container = (function() {
    ...
    /**
     * these attributes will be API, has been called
     * @type {String} VERSION Used as the semantic version number
     * @type {function} get Use to get the module
     * @type {function} set Use to set the module
     * @type {function} del Use to set the module
     * @type {function} inject Use to inject the desired module
     */
    ...
    return CacheAPI
    /**
     * [constructor Used to simplify access]
     * @param    {string}
     * @param    {object}
     * @return   {*}
     */
     ...
     * @Author    liyang
     * @mail      ly20479293@gmail.com
     * @DateTime  2017-03-28T11:24:27+0800
     */
    function Injection(){
        this.receiver = null;
    ...
    /**
     * [InjectionManagerConstructor  注入器管理者， only one]
     * @Author    liyang
     * @mail      ly20479293@gmail.com
     * @DateTime  2017-03-28T09:59:06+0800
     */
